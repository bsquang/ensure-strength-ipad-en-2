...
function nextBUTTON() {
  ...
  if (current == 2) {
	...
	if (total.percent > 95) {
	  ...
	  var temp = "With your strength at the age "+getAge(user.age)+", you are facing with health loss, the most visible consequences are:";
...
function calPTLK(type) {
  ...
  for(var i=0;i<weaks_female.length;i++){
    ...
    divTarget.highcharts({
      ...
      var tempDIV = "Strong: " + pos_strongs;
      tempDIV += "<br>";
      tempDIV += "<b>You: " + pos_user;
      tempDIV += "</b><br>";
      tempDIV += "Weak: " + pos_weaks;
